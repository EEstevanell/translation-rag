"""Jaccard similarity based retrieval strategy."""
...
class JaccardRAG(RAGStrategy):
    ...
    def get_context(
        ...
        results = self.memory.retrieve_jaccard(
            text,
            source_lang,
            target_lang,
            k=k,
        ...
        self.logger.info(
            f"Retrieved {len(results)} documents using Jaccard search "
